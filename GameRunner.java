        ...
        for(String cardsuit: retrievedSuit ) {
            for (String cardValue : retrievedValue) {
                if (cardValue.equals("A")) {
                    ...
                    cards.add(new Card(cardValue, cardsuit, 2, 10));
                } else if ( cardValue.equals("Q")) {
                    cards.add(new Card(cardValue, cardsuit, 3, 10));
                } else if ( cardValue.equals("J")) {
                    cards.add(new Card(cardValue, cardsuit, 4, 10));
                } else if ( cardValue.equals("10")) {
                    cards.add(new Card(cardValue, cardsuit, 5, 10));
                } else if ( cardValue.equals("9")) {
                    cards.add(new Card(cardValue, cardsuit, 6, 9));
                } else if ( cardValue.equals("8")) {
                    cards.add(new Card(cardValue, cardsuit, 7, 8));
                } else if ( cardValue.equals("7")) {
                    cards.add(new Card(cardValue, cardsuit, 8, 7));
                } else if ( cardValue.equals("6")) {
                    cards.add(new Card(cardValue, cardsuit, 9, 6));
                } else if ( cardValue.equals("5")) {
                    cards.add(new Card(cardValue, cardsuit, 10, 5));
                } else if ( cardValue.equals("4")) {
                    cards.add(new Card(cardValue, cardsuit, 11, 4));
                } else if ( cardValue.equals("3")) {
                    cards.add(new Card(cardValue, cardsuit, 12, 3));
                } else if ( cardValue.equals("2")) {
                    cards.add(new Card(cardValue, cardsuit, 13, 2));
                }
            }
        }
